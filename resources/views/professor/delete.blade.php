...
<main class="container">
    ...
    <form action="{{ route('professor.destroy',$professor->id)}}" method="POST">
        ...
        <input type="text" name="nome" id="nome" value="{{$professor->nome}}" class="form-control" disabled><br>
        <div class="row">
        <div class="col-6">
        <label for="materia" class="form-label">Materia do Professor</label>
        <input type="text" name="materia" id="materia" value="{{$professor->materia}}" class="form-control" disabled><br>
        </div>
        </div>
